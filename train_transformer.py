...
def train(model, train_data, optimizer, criterion, scheduler, epoch, bptt):
...
def main(argv):
    ...
    for epoch in range(1, epochs + 1):
        ...
        train(model, train_data, optimizer, criterion, scheduler, epoch, bptt)
    ...
    test_loss = evaluate(best_model, test_data, criterion, bptt)
    print('=' * 89)
